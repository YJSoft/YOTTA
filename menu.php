		...
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li<?php if ($mode === 'list') echo ' class="active"'; ?>><a href="./<?php echo getUrl('list.php') ?>" hreflang="<?php echo $_SESSION['lang'];?>"><?php echo $str['list']; ?></a></li>
					<li<?php if ($mode === 'about') echo ' class="active"'; ?>><a href="./<?php echo getUrl('about.php') ?>" hreflang="ko"><?php echo $str['about']; ?></a></li>
<?php
					if ($mode === 'download') {
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="./<?php echo getUrl('lang') ?>"<?php if ($_SESSION['lang'] == 'ko') {
